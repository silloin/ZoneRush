  ...
  const fetchDashboardData = async () => {
    ...
    try {
      const [
        ...
        axios.get(`/runs/user/${userId}/stats`),
        axios.get(`/runs/user/${userId}/pace-progression?limit=30`),
        axios.get(`/runs/user/${userId}/distance-progression?days=${timeRange}`),
        axios.get(`/runs/user/${userId}/heatmap?days=90`),
        axios.get(`/runs/user/${userId}/weekly-comparison`),
        axios.get(`/ai-coach/recommendations/${userId}`)
      ]);
